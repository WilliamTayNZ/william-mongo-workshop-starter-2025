import "dotenv/config"; // When program runs, will read .env file
...
await PokemonSpecies.deleteMany({}); // {} is the query, so you can specify what to delete but blank will delete all
